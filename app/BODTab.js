...
// All Spend tab shows raw LinkedIn data only — no ref-sheet/PMF/ZAR calculations.
// Those calculations now live exclusively on the BOD tab.
...
export default function BODTab() {
  ...
  // All Spend shows raw LinkedIn columns only (matches Client Breakdown); the
  // PMF/FX/ZAR calculated columns now live exclusively on the BOD tab (and
  // continue to appear on Self-Managed/COD, unchanged from before).
  const activeCols = activeReportTab === 'All Spend' ? SIMPLE_COLS : COLS;
